      ...
      <span>
        <el-form>
          ...
          <el-form-item label="手机号" class="colors">
            <el-input v-model="userInfo.userphone" placeholder="Please input" />
          </el-form-item>
          <el-form-item label="验证码" class="colors">
            <el-input v-model="userInfo." placeholder="请输入验证码" />
            <span @click.stop="refreshCode2" style="cursor: pointer">
              <SIdentify2 :identifyCode="regeidentifyCode"></SIdentify2>
            </span>
          </el-form-item>
        </el-form>
      </span>
